    ...
    <div>
        <b-navbar class="navbar" toggleable="md" type="dark" style="padding-right:100px;padding-left:100px;padding-top:200px" >
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter"><i style="font-size:18px;margin-right:10px" class="fas fa-plus-square"></i>Post</button>
                </b-nav-form>
            </b-navbar-nav>
